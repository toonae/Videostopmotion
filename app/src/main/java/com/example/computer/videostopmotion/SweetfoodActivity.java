...
public class SweetfoodActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sweetfood);
        ...
        mlist.add(new item(R.drawable.food,"บัวลอย",R.drawable.bua));
